...
@Configuration
@EnableJpaRepositories(basePackages = "com.auction.repository", entityManagerFactoryRef = "EntityManagerFactoryBean")
...
public class DbConfig {
    ...
    private static final String VALUE_HIBERNATE_BATCH_SIZE = "6";
    private static final String ORDER_INSERTS = "hibernate.order_inserts";
    private static final String VALUE_ORDER_INSERTS = "true";

    private static final String MODEL_PACKAGE = "com/auction/model";
    ...
    private Properties hibernateProps() {
        ...
        properties.put(HIBERNATE_BATCH_SIZE, VALUE_HIBERNATE_BATCH_SIZE);
        properties.put(ORDER_INSERTS, VALUE_ORDER_INSERTS);
        return properties;
    }
